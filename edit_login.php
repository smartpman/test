				...
				<h3 style="text-align:center">EDIT LOGIN</h3>
					...
					<div class="form-group">
						<div class="col-md-offset-5 col-md-7">
							<button type="submit" class="btn btn-default" onclick="validate_Form();">Login</button>
						</div>
					</div>
				</form>
				</div>
