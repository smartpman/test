...
<body class="wrapper">
	<div class="container">
				...
				<nav class="navbar navbar-default" role="navigation">
					...
					<div class="col-md-4 collapse navbar-collapse" id="example-navbar-collapse">
							<ul class="nav navbar-nav">
								<li class="active"><a href="#" style="color:#000;">About Us</a></li>
		...
		<div class="row">
			<div class="col-md-12">
				<h1 style="text-align:center;">Welcome To Task Scheduling and Monitoring.</h1>
				<h2 style="text-align:center;">A SubDivision of IDC Construction Company.</h2>
				<h3 style="text-align:center;">Providing Quality Services is Our Aim.</h3>
				<h4 style="text-align:center;">Welcome To The Administrators Panel.</h4>
			</div>
		</div>
