...
<body class="wrapper">
	<div class="container">
		...
		<?php require_once("includes/staff_process.php"); ?><!-- This is where we send the value that is been submitted tru the browser -->
		<div class="row">
			 <form role="form" class="form-horizontal form_style2" name="myForm" action="<?php $_SERVER["PHP_SELF"]; ?>" method="post" >
				<h3 style="text-align:center; color:#000;">TEAM LEADER REGISTRATION</h3>
				<div class="form-group">
					<label class="col-md-3 control-label">StaffID:</label>
					<div class="col-md-6">
