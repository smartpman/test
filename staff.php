...
<body class="wrapper">
	<div class="container">
		...
		<div class="row">
					<div class="col-md-12">
						<h1 style="text-align:center;">Welcome To The Staff Module of IDC Construction Company</h1>
						<h2 style="text-align:center;">Providing Quality Services is Our Aim</h2>
						<h3 style="text-align:center;">This Module Allows Staff Perform All Necessary Operations.</h3>
					</div>
		</div>
